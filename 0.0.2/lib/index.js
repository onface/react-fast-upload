    ...
    _createClass(Upload, [{
        ...
        value: function render() {
            ...
            return require("react").createElement(
                "span",
                { className: props.clsp + '-upload' + ' ' + props.wrapClassName, onClick: function onClick() {
                        self.refs.rfUploadInput.click();
                    } },
                require("react").createElement("input", { ref: "rfUploadInput",
                    type: props.type,
                    name: props.name,
                    accept: props.accept,
                    key: this.state.uid,
                    className: props.clsp + '-upload-input' + ' ' + props.wrapClassName,
